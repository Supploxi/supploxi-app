...
const client = new Client({
  connectionString: 'postgresql://postgres:supploxi.95%40@db.nmlnwcclgufxjkklqntl.supabase.co:5432/postgres',
...
const statements = [
  ...
  // 9. RLS Policies (DROP IF EXISTS then CREATE to be idempotent)
  `DO $$ BEGIN
